                                                      ...
                                                      form.submit(function (e) {
                                                          ...
                                                          if (
                                                              ...
                                                              if ($.isFunction(settings.target)) {
                                                                  ...
                                                                  var submitdata = {};
                                                                  (submitdata[settings.name] =
                                                                      input.val()),
                                                                      (submitdata[settings.id] =
                                                                          self.id),
                                                                      $.isFunction(
                                                                          settings.submitdata
                                                                      )
                    ...
                    (settings.submit &&
                        (settings.submit.match(/>$/)
                            ...
                            : ((submit = $('<button type="submit" />')).html(settings.submit),
                              settings.submitcssclass && submit.addClass(settings.submitcssclass)),
                        $(this).append(submit)),
                    settings.cancel) &&
                        (settings.cancel.match(/>$/)
                            ? (cancel = $(settings.cancel))
                            : ((cancel = $('<button type="cancel" />')).html(settings.cancel),
                              settings.cancelcssclass && cancel.addClass(settings.cancelcssclass)),
                        $(this).append(cancel),
            ...
            textarea: {
                element: function (settings, original) {
                    ...
                    return (
                        ...
                        settings.maxlength && textarea.attr('maxlength', settings.maxlength),
