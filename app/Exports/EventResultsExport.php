...
class EventResultsExport implements  FromView,WithHeadings, WithEvents
{
...
$genders = $genders->get();
return view('players.resultExport', [
    'genders' => $genders,
    'id'=>$this->id]);
}
...
public function registerEvents(): array
{
    return [
        AfterSheet::class    => function(AfterSheet $event) {
            ...
            $event->sheet->getStyle('A2:H2')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'D9D9D9'],]);
