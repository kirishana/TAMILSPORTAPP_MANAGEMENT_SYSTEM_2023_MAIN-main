<div class="row" id="champions">
    ...
    <div class="tab-content"  >
        <div class="tab-pane fade active in" id="tab1">
            <div class="panel-body text-uppercase table-responsive">
                <div class="row" >
                ...
                <table class="table table-striped table-bordered" id="showall" style="overflow:hidden">
...
<?php
        ...
        <div class="tab-pane" id="tab2">
            <div class="panel-body table-responsive">
                ...
                <table class="table table-striped table-bordered" id="clubs">
                <thead class="thead-Dark">
                                <tr>
                                    <th>Clubs</th>
