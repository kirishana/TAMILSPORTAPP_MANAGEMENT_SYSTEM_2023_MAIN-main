...
border-collapse: collapse;">
        ...
        <tbody class="text-uppercase">
            ...
            text-align: left;border: 1px solid black;">{{++$key}}</td>
                ...
                <td style="padding: 3px;
                width: 1%;
                text-align: left;border: 1px solid black;"><?php $age=Carbon\Carbon::parse($user->dob)->diff(Carbon\Carbon::now())->y ?>{{ $age }}</td>
                <td style="padding: 3px;
                width: 1%;
                ...
                <td style="padding: 3px;
                width: 1%;
                text-align: left;border: 1px solid black;">{{$user->member_or_not==1 ? 'Yes' : 'No'}}</td>
                @endif
                @endif
                @endif
