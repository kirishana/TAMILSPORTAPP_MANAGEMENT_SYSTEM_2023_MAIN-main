                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <label>
                                    <input type="radio" checked class="custom-radio" name="radioAge[]" id="radio_four" value="all">&nbsp; All</label>
                            </div>
                                </form>
                                </div>
                            <div class="panel-body table-responsive">
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row filter">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <label>
                                        <input type="radio" checked class="custom-radio2" name="radioAge[]" id="radio_four" value="all">&nbsp; All</label>
                                </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/vendors/jeditable/js/jquery.jeditable.min.js') }}" ></script>
