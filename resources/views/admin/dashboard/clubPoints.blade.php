<table class="table table-striped table-bordered" id="champions">
                            ...
                            <tbody id="clubs" style="text-transform:capitalize;">
                                ...
                                @endforeach
                                 ...
                                 <?php
                                        ...
                                        $marathonPoints = App\Models\MarathonPoint::where('league_id', $ongLeague->id)->get();
