            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="material-icons">person_add</i>
                        ...
                        <a style="float:right;display:block" href="/user/{{Crypt::encrypt(Auth::user()->id)}}" style="color:white"><i class="material-icons  leftsize">keyboard_backspace
                        </i>
                            Back</a>
                    </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <form name="commentForm" id="commentForm" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div>
                                    ...
                                    <ul style="background:none" class="nav nav-tabs" id="nav-tab">
                                        <li class="active">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="tab1">
                                            ...
                                            <div class="form-group {{ $errors->first('password', 'has-error') }}">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="password" name="password" type="password" placeholder="Password" class="form-control" value="{!! old('password') !!}" />
                                                </div>
                                            ...
                                            <div class="form-group {{ $errors->first('password_confirm', 'has-error') }}">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="password_confirm" name="password_confirmation" type="password" placeholder="Confirm Password " class="form-control" value="{!! old('password_confirm') !!}" />
                                                </div>
                                        ...
                                        <div class="tab-pane" id="tab2" disabled="disabled">
                                            ...
                                            @if ($age<18) <div class="form-group {{ $errors->first('dob', 'has-error') }}">
                                        ...
                                        <div class="form-group {{ $errors->first('gu_email', 'has-error') }}">
                                        ...
                                        <div class="form-group {{ $errors->first('gu_number', 'has-error') }}">
                                        ...
                                        <div class="form-group {{ $errors->first('ImageUrl', 'has-error') }}">
                                            <div class="col-sm-10" style="margin-left:100px ;">
                                                <div class="fileinput fileinput-new image_area" data-provides="fileinput">
                                                <label for="upload_image">
                                                @if($user->profile_pic)
                                                        <img src="/profile/{{ $user->profile_pic}}" class="img-responsive img-circle"  id="uploaded_image" alt="Tamil Sangam">
                                                        @elseif(Auth::user()->gender=="male")
                            <img src="{{ asset('assets/images/authors/malelogo.png') }}" alt="..." id="uploaded_image" class="img-circle  img-responsive pull-left"   class="img-circle" />
                            @else
                            <img src="{{ asset('assets/images/authors/avatar5.png') }}" alt="..." id="uploaded_image" class="img-circle  img-responsive pull-left"  class="img-circle" />
                            @endif
								<div class="overlay">
