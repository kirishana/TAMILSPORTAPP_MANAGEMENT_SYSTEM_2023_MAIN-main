...
{{ __('staffs.add_new_staff') }}   
                     <div style="float:right">
                            <a href="/organization-staffs" style="color:white">
                                {{ __('staffs.back') }} </a>
                        </div>
                    </h3>
                ...
                <div class="panel-body">
                    ...
                    <form class="form_action6" action="/organization/staff/store" method="POST">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <label class="control-label code" for="tel-number">{{ __('dashboard.phone_no') }}   </label>
                                            <?php $org=App\Models\Organization::find(Auth::user()->organization_id?Auth::user()->organization_id:$id);
                                            ?>
                                            <div class="row">
                                                <div class="col-md-1 code" style="margin-top:3%;display:hidden;">
                                                  
                                                    {{ $org->country->countryCode->name }}
                                                </div>
                                                    <div class="col-md-10">
                                            <input id="tel-number" name="tel-number"  
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                            maxlength = "8"  type="number" class="form-control" value="{!! old('tel-number') !!}">
                                                    </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group ">
                                        <div class="input-group">
                                            ...
                                            <input id="dob" name="dob"   type="date"  class="form-control" max={{$today}}  value="{!! old('dob') !!}">
                                        </div>
...
?>
                                                ...
                                                <select id="select22" name="club" class="form-control select2">
                                                    <option value="{{ Auth::user()->club_id }}" selected>{{ Auth::user()->club->club_name }}</option>
