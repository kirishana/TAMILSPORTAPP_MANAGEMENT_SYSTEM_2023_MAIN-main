                                                    ...
                                                    <div class="col-md-5 form-group">
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <label class="control-label" for="firstName3">League Name<span style="color:red;"> <b> * </b></span>
                                                               ...
                                                               <input type="hidden" class="form-control" name="league" value="{{ $event->league->id }}">
                                                    ...
                                                    <div class="col-md-5 form-group">
                                                        ...
                                                        <br>                           
                                                            ...
                                                            @foreach ($genders as $gender)
                                                                <div class="col-md-6">
                                                                    <input name="genders[]"  type="checkbox" value="{{ $gender->id }}" @foreach($agegenders  as $gen){{$gen->gender_id == $gender->id ? 'checked': ''}}   @endforeach>{{ $gender->name }}
                                                                </div>
                                                            @endforeach   
