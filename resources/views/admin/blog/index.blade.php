        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                <h4 class="panel-title pull-left">
                    <i class="livicon" data-name="edit" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Blog List
                </h4>
                <div class="pull-right">
                    <a href="{{  URL::to('admin/blog/create') }}" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                    ...
                    @if(!empty($blogs))
                        @foreach ($blogs as $blog)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('admin/blog/' . $blog->id ) }}"><i class="material-icons text-primary mate-icons" title="@lang('blog/table.view-blog-comment')">info</i> </a>
