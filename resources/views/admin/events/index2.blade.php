...
$(document).on('click','.change',function(e){
    ...
    $("input:checkbox[name*=agegroup]:checked").each(function(){
         arr.push($(this).val());
    });
            $.ajax({
                type:"POST",
      ...
      <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>             
        ...
        <input type="hidden" id="deleted_id">
         ...
         <input type='hidden' name='data_id' id="del_id"/>   
          <div class="modal-body">   
                Are you sure you want to delete?    
                 <div class="form-group">
                                    ...
                                    @foreach($judges as $agegroup)
                                    <input class="agegroup[]" type="checkbox" name="agegroup[]" value="{{$agegroup->id}}">
                                    {{$agegroup->first_name}}
                                    @endforeach
                                    <br>
                                    
                                    @foreach($starters as $agegroup)
                                    <input class="agegroup[]" type="checkbox" name="agegroup[]" value="{{$agegroup->id}}">
                                    {{$agegroup->first_name}}
                                    @endforeach
                            </div>        
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            <input type="submit" class="btn btn-danger change" value='Delete'/>
          </div>
    </div>
  </div>
</div>
