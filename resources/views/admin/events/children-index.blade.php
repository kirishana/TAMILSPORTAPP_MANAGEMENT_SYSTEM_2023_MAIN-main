        ...
        <div class="panel panel-primary ">
            <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    Events (Registering for {{$user->first_name}} {{$user->last_name}})
...
@endforeach
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                @if ($upcomingEvent->is_approved == 0)
...
<td>
                                             <a href="/event/{{ $upcomingEvent->id }}/edit/{{$upcomingEvent->user_id}}">
                                                    ...
                                                    $leagues = $org->leagues->where('reg_start_date','<=',Carbon\Carbon::now()->format('Y-m-d'))->where('reg_end_date','>=',Carbon\Carbon::now()->format('Y-m-d'));
                                                        ...
                                                        ?>
                                                            ...
                                                            if (!in_array($league->id, $regs)) {
                                                                $userGender = $user->gender == 'male' ? 1 : 2;
