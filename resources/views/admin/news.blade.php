                        ...
                        <div id="myCarousel" class="carousel image-carousel slide">
                            <div class="carousel-inner">
                                <div class="active item">
                                    <img src="{{ asset('assets/img/authors/avatar.jpg') }}" class="img-responsive" alt="missingimage">
                                </div>
                                <div class="item">
                                    <img src="{{ asset('assets/img/authors/avatar1.jpg') }}" class="img-responsive" alt="missingimage">
                                </div>
                                <div class="item">
                                    <img src="{{ asset('assets/img/authors/avatar2.jpg') }}" class="img-responsive" alt="missingimage">
                                </div>
                            </div>
                            <!-- Carousel nav -->
