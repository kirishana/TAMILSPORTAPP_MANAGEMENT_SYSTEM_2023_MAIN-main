                        ...
                        <tbody>
                            ...
                            <td style="border-top: 2px solid white;">
                                ...
                                foreach ($result as $res) {
                                    $user = \App\User::whereIn('id', [$res])->first();
                                    echo $user->userId;
                                    echo "<br>";
                                ?>
                                    <?php
                                    $ageGrp = DB::table('age_group_gender_user')->where('user_id', $user->id)->where('age_group_gender_id', $gender->id)->first();
                                    ?>
                        ...
                        <tbody>
                            <form action="/track/heats/starter" method="get">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            {{ $player->userId }} {{-- <input type="checkbox" name="players[]" value="{{$player->id}}"><br> --}}
                                            <br>
                                            <input name="_token" type="hidden" value="{{ csrf_token() }}" />
                                            <input type="hidden" value="{{ $gender->id }}" name="gender">
                                            <input type="hidden" value="{{ $event->id }}" name="event">
                                ...
                                <td style="border-top: 2px solid white;">
                                    ...
                                    <?php
                                    foreach ($result as $res) {
                                        $attr = \App\User::whereIn('id', [$res])->first();
