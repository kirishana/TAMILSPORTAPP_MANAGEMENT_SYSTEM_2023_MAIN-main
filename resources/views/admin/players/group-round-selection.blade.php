                        ...
                        <tbody>
                            ...
                            <td style="border-top: 2px solid white;">
                                ...
                                foreach ($result as $res) {
                                    $team = \App\Models\Team::whereIn('id', [$res])->first();
                                    echo $team->name;
                                    echo "<br>";
                                ?>
                                    <?php
                                    $ageGrp = DB::table('age_group_gender_team')->where('team_id', $team->id)->where('age_group_gender_id', $gender->id)->first();
                                    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            {{ $player->name }} {{-- <input type="checkbox" name="players[]" value="{{$player->id}}"><br> --}}
                                            <br>
                                            <input name="_token" type="hidden" value="{{ csrf_token() }}" />
                                            <input type="hidden" value="{{ $gender->id }}" name="gender">
                                            <input type="hidden" value="{{ $event->id }}" name="event">
