                        ...
                        <tbody>
                            ...
                            <form action="/track/heats" method="get">
                                ...
                                <form action="/track/heats/starter" method="get">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <input type="checkbox" name="players[]" value="{{$player->id}}">
                                                @endif
                                                <br> <input name="_token" type="hidden" value="{{ csrf_token() }}" />
                                                <input type="hidden" value="{{ $gender->id }}" name="gender">
                                                <input type="hidden" value="{{ $event->id }}" name="event">
                                                <?php
                                                $array[] = $player->id;
                                    ...
                                    ?>
                                    @if(Auth::user()->hasRole('Starter'))

                                    @foreach($allplayers as $sor)
                                    ...
                                    <td style="border-top: 2px solid white;">
                                        ...
                                        ?>
                                            @if(Auth::user()->hasRole(6))
                                            <input type="checkbox" name="players[]" value="<?php echo $res ?>"> @endif
                                            <br>
