        ...
        <div class="panel panel-primary ">
            <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    {{$AgeGroupGender->ageGroupEvent->Event->mainEvent->name}}-{{$AgeGroupGender->ageGroupEvent->ageGroup->name}} - ({{ $AgeGroupGender->gender->name  }})
            ...
            <div class="panel-body table-responsive">
                <form action="/event/group-participated-players" method="POST">
                        ...
                        <table class="table table-striped table-bordered events" id="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td><input type="checkbox" name="attendances[]" value="{{ $team->id}}">
                                   @endforeach
