...
@stop
    ...
    @stop
        ...
        <section class="content-header">
            <!--section starts-->
            <h1>Participant's Registrations OverView</h1>
            <ol class="breadcrumb">
                <li>
                    <a href="">
                ...
                <li class="active">Participant's Registrations OverView</li>
            </ol>
        </section>
        <!--section ends-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary filterable">
                        <div class="panel-heading">
                            ...
                            Participant's Registrations OverView
                            </h3>
                        </div>
                        <div class="row">
                                ...
                                <div class="tab-content">
                                                    ...
                                                    @foreach($leagues1 as $season)
                                                        @if($season->id==$ongngLeagues->id)
                                                            <option selected value={{ $season->id }}
                                                                data-name={{ $season->name }}>{{ $season->name }}
                                                            </option>
                                                        @else
                                    ...
                                    <div class="row ">
                                        <div class="col-md-2 pull-right"
                                            ...
                                            <a href="/partRegOverview/excel"><button type="button" class="btn btn-primary"
                                                    data-column="0">Download Excel</button></a>
                            ...
                            @include('admin.PDF.PartRegOverviewfilter')
                                        </div>
                                    </div>
                                </div>
                            </div>
