...
<div class="row">
  ...
  <div class="card-body" >
    ...
    <p class="card-text text-center" style="font-size: 25px;">{{ $total }}</p>
  </div>
</div>
</div>
    <!--main content-->
            ...
            <form action="/event/register" method="POST">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion" role="tablist">
                            <div class="panel panel-default">
                                ...
                                $bank=App\Models\ActivePaymentMethod::where("organization_id",$organization)->where('bank_transfer_id',$org->bankTransfer?$org->bankTransfer->id:'')->first();
                    ...
                    <form action="/event/register" method="POST">
                        ...
                        // dd($org);
                                $org=App\Models\Organization::find($organization);
                                $vipps=App\Models\ActivePaymentMethod::where("organization_id",$organization)->where('vipps_id',$org->Vipps?$org->Vipps->id:'')->first();
                                ?>
                        @if($vipps)
