...
<section class="content">
  ...
  <div class="card-body">
    ...
    <p class="card-text text-center" style="font-size: 22px;">{{ $iso }} {{ $total }}</p>
  </div>
</div>
</div>
        ...
        <div class="col-md-8">
            <form action="/group-event/edit" method="POST">
                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion" role="tablist">
                            <div class="panel panel-default">
                                <?php 
                                $bank=App\Models\ActivePaymentMethod::where("organization_id",$org->id)->where('bank_transfer_id',$org->bankTransfer?$org->bankTransfer->id:'')->first();
                                $vipps=App\Models\ActivePaymentMethod::where("organization_id",$org->id)->where('vipps_id',$org->Vipps?$org->Vipps->id:'')->first();
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" action="{{ route('stripe.editGroupEvent') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                                    @csrf
