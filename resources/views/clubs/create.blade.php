                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label class="control-label" for="club_name">Club Name<span
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label class="control-label" for="club_registation_num">Club Register
                                                    Number</label>
                                        ...
                                        <div class="form-group {{ $errors->first('club_start_date', 'has-error') }}">
                                            <div class="input-group">
                                                ...
                                                <input id="club_start_date" name="club_start_date" type="date"
                                                    class="form-control"  value="{!! old('club_start_date') !!}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group label-floating {{ $errors->first('club_email', 'has-error') }}">
                                            <div class="input-group">
                                                ...
                                                <label class="control-label" for="club_email">E-mail<span
                                                        style="color:red;"> <b> * </b></span></label>
                                                <input id="club_email" name="club_email"  type="email"
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-12">
                                            ...
                                            <div
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <label class="control-label" for="city">City<span style="color:red;">
                                                            <b> * </b></span></label>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="material-icons text-light">location_city</i></span>
                                                    <label class="control-label" for="state">State<span style="color:red;">
                                                            <b> * </b></span></label>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group  {{ $errors->first('country', 'has-error') }}">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            ...
                                                            <label class="control-label" for="mobile">Select Country<span
                                                                style="color:red;"> <b> * </b></span></label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <label class="control-label" for="mobile">Mobile Number<span
                                                        ...
                                                        <div class="col-sm-1  code"
                                                            style="margin-top:5%;display:hidden;"></div>
                                                        <div class="col-sm-11">
                                                            <input
                                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                               <div
                                                ...
                                                <div class="input-group"  style="margin-top:2%;">
                                                    ...
                                                    <label class="control-label" for="postal">Postal Code<span
                                                            style="color:red;"> <b> * </b></span></label>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6" style="display:;" id="Prefix">
                                               <div
